function [coord_asc, synapse_indices_asc, synapse_depths_asc, synapse_xs_asc, coord_desc, synapse_indices_desc, synapse_depths_desc, synapse_xs_desc] = Prototype_make_axon_dIN_L(rc, dorsal_dendrite, ventral_dendrite, cell_types, this_cell_index,cell_pos,flag_asc) % true/is ascending   
synapse_indices_asc = [];
synapse_depths_asc = [];
synapse_xs_asc = [];
...
alphas=0.15;%0.2575;%0.069;%0.05376; % stochasticity SECONDARY

gRs=0.050;%0.041246; %Initial values of the sensitivities
gVs=0.110;%0.17404; 
gDs=0.026;%0.78125;

gfRs=0.050;%0.041246; % final values of gradient sensitivities
gfVs=0.110;%0.17404;
gfDs=0.026;%0.78125;
...
alphas=0.15;%0.2575;%0.08;%0.05376; % stochasticity SECONDARY

gRs=0.05;%0.034;%0.020096987625927;% %0.1; %Initial values of the sensitivities
gVs=0.110;%0.064; %0.031790578726578;%
gDs=0.026;%0.386;%0.025;%0.1;
...
%          cont_prob=0.63;
%      end;
%      if cell_types(this_cell_index) == 5 || cell_types(nearest_dend_index)==5
%          cont_prob=0.46;
%      end;
%           
  if dis10>=10   
