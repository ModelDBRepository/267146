function [coord_asc, synapse_indices_asc, synapse_depths_asc, synapse_xs_asc, coord_desc, synapse_indices_desc, synapse_depths_desc, synapse_xs_desc] = Prototype_make_axon_dla_L(rc, dorsal_dendrite, ventral_dendrite, cell_types, this_cell_index,cell_pos) % true/is ascending   
synapse_indices_asc = [];
synapse_depths_asc = [];
synapse_xs_asc = [];
...
initial_angle=normrnd(-143,29);%pi*[25.346 20.556 -26.565 -0.93919 7.4959 7.125 -3.8141 -2.3859 -3.0128]./180;%steve point outgrowth angle%normrnd(-143,29);
branch=1;
branch_angle=0;
%
%%
...
%       if i ~= this_cell_index
%           rectangle('Position',[synapse_xs_desc(i)-0.5,synapse_depths_desc(i)-0.5,1,1],'FaceColor',cell_colours(cell_types(this_cell_index),7:3),'Curvature',[1,1]);
%       end
% end